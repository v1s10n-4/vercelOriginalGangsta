> # [WARNING] This project is NOT the official @vercel/og source code, it's just code from parsed sourcemaps of its 0.0.21-beta.1 version. Here only for documentation purpose
